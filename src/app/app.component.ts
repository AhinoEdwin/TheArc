...
export class AppComponent {
  ...
  public location =[    { name: 'Location', url: '#', imagePath: 'assets/location.jpg',message:"12th Floor, Tower CS7, Supertech Capetown, Plot No - GH01/A, Sector-74, Noida, Gautam Buddha Nagar, Uttar Pradesh, 201 305" }]
}
